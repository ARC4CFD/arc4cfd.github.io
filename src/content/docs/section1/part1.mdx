...
- **CPU & Memory**: the [Central Processing Unit (CPU)](https://arc4cfd.github.io/glossary/#section-2) and memory, usually interconnected, are the engine of the computing machine and are used to execute operations and store results.
