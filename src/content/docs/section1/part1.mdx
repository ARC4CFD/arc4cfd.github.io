...
In the previous figure, the CPU is represented as a "black box", however it is very important for later sections in this course, to understand its **purpose** and its **structure**. The CPU or Central Processing Unit is the "brain" of the computer. As shown in the schematic below, it is in charge of completing tasks by **continuously** processing and resolving mathematical/logical operations.
