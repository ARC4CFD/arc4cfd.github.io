...
| 30 min | [Allocating resources and running jobs using SLURM](../part3) | <ul><li>What is SLURM?</li><li>How do I run simulations in HPC?</li><li>What about software in HPC?</li></ul> |
