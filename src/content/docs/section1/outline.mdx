...
| 60 min | [Allocating resources and running jobs](../part3) | <ul><li>How do I run a job in interactive mode on the cluster?</li><li>How do I submit a batch script to SLURM?</li><li>How do I load my favorite CFD software?</li></ul> |
