...
In this very simple example code we check if a specific year is a leap year. **The purpose is to run this code on the cluster using all methods learned so far**.
