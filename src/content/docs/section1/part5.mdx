...
In this section you will solve a practical problem taking advantage of all you have learned in the previous sections. Say your task is to study how heat is conducted in a square plate in which the 4 boundaries are at different temperatures and a heat source is present at the center of the domain. As you may recall, this problem is mathematically described by the Poisson equation:
$$
