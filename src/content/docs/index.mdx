...
<CardGrid stagger='true'>
  <Card title="Talking point 1" icon="pencil">
		Talking point here
	</Card>
	<Card title="Talking point 2" icon="puzzle">
		Talking point here
	</Card>
  <Card title="Talking point 3" icon="laptop">
		Talking point here
	</Card>
  <Card title="Talking point 4" icon="open-book">
		Talking point here
	</Card>
</CardGrid>
...
<br/>
<CardGrid>
  <LinkCard title="About ARC4CFD" href="./about"/>
  <LinkCard title="Meet the developers" href="./course_developers"/>
</CardGrid>
