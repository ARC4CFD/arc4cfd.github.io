...
<CardGrid>
	...
	<Card title="Course developers" icon="add-document">
		Add Markdown or MDX files to `src/content/docs` to create new pages.
	</Card>
	<Card title="Licence" icon="setting">
		ADD LICENCE LINK HERE
	</Card>
	<Card title="Other resources" icon="open-book">
