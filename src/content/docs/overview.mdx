...
---
  ...
  **Advanced Research Computing for Computational Fluid Dynamics**, or **ARC4CFD**, is a 16-hour online, asynchronous course to help learners with a cursory knowledge of fluid dynamics and CFD bridge the knowledge gap toward the effective utilization of CFD on modern ARC resources. 
<p align="center">
...
The prerequisites  for the class are noted [here](https://arc4cfd.github.io/prereqs).
