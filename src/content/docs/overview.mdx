...
---
  ...
  Advanced Research Computing for Computational Fluid Dynamics, or **ARC4CFD**, is a 16-hour online, asynchronous course to help learners with a cursory knowledge of fluid dynamics and CFD bridge the knowledge gap toward the effective usage of CFD on modern ARC resources. 
<p align="center">
...
- [**Section 1**: Foundational aspects of ARC](https://arc4cfd.github.io/section1)
- [**Section 2**: Leveraging HPC for large-scale CFD computations](https://arc4cfd.github.io/section2)
