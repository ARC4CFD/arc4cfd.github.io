...
:::tip[Scripting for three-dimensional plotting]
...
![Tripcolor plot.](../../../assets/figs_section2/tripcolor.png ".")
        <Caption>Steps to generate batch script in VisIt. </Caption>

2. Open the CFD results, setup as desired, and select the desired output.

3. Stop the recording in the command window.

4. Copy the script to the remote HPC system into a myVizScript.py file and adjust parameters accordingly (e.g. path to the results)
