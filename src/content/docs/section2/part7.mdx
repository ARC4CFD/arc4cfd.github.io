...
<p style={{ color: "purple"}}>**2.7.2 Now assume that you are on a login node of an HPC system and you wish to use rsync to transfer a small file (log.txt) to your project directory.**</p>
<MultipleChoice>
    <Option>
scp -r ~/Downloads user@niagara.alliancecan.ca:/scratch/m/myuser/Results  
    </Option>
