...
1. Take an *iterative* approach to setting up the problem, but take a methodological approach large-scale CFD case 
2. Start small and build up complexity towards full scale problems
3. Always question, criticize, and check results
4. Optimize the computational resource utilization
