...
In this standard workflow, the numerical problem is defined and computational domain discretized in the **preprocessing** step, while the simulations are run in the **processing**, and data is analyzed and visualized in the **post-processing**.
