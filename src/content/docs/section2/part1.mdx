...
4. **Numerical and modeling errors**:
3. **Computational ressources and knowledge**: Given the use cases described above and the multi-scale nature of the underlying problem, it becomes clear that computational ressources represent one of the largest limitations for CFD. 
