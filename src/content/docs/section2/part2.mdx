...
- **Simulation parameters**
	...
	* *Modeling of multiphysics or multiphase problem*
...
The following figures show decaying isotropic turbulence simulated in a two- (left) and three-dimensional (right) domain, where the vorticity is shown. Note the very clear difference between the turbulence in both cases, in 2D we clearly that the turbulence stretching occurs in a single plane, we note the clear filamentary structures in the turbulence, which are not visible in 3D.
<CardGrid>
