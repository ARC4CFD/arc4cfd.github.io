...
![HPCcompromise.](../../../assets/figs_section2/ARC4CFD_alignment.svg "Alignment in CFD")
<Caption>Alignment  between various consideration for CFD simulations. </Caption>
...
## Strategies for working on clusters
