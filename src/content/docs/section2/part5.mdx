...
<Box iconName='exercise'>
### EXAMPLE: Why do I need to scaling tests on my specific case?
We often face the temptation of relying on someone else's scaling to inform our scaling analysis. But it's important on a problem as close to the reality as possible

As an example, we conduct a scaling test on OpenFoam on two different solvers within openFoam and different size of mesh.
...
![HPCcompromise.](../../../assets/figs_section2/ARC4CFD_strongScaling_compare.png "Strong scaling of a CFD code.")
<Caption>. </Caption>
