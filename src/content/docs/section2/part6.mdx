...
<font size="+3">**Example: estimating number of files**</font>
...
Binary format is faster for **read/write** since the machine does not have to convert to a human-readable format. The size of a binary output file is also smaller as compared to an ASCII file. Most binary format are  platform-dependent and not easily transferable between systems. 
:::
