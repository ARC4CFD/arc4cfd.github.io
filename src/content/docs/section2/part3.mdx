...
The larger velocity gradient of the turbulent boundary layer will result in a smaller grid spacing at the wall than a typical laminar boundary layer. To determine the mininal
...
Velocity             |  Temperature
:-------------------------:|:-------------------------:
![HPCcompromise.](../../../assets/figs_section2/ARC4CFD_lawoftheWall_semiLog.png "Estimate HPC costs of the CFD simulation") | ![HPCcompromise.](../../../assets/figs_section2/ARC4CFD_compareBL_T.png "Estimate HPC costs of the CFD simulation")
