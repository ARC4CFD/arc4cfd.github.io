...
The generalization of the grid estimates for more general problems in multiphase or multi-physics simulations, is outside the scope of this course. We need to resolve both the hydrodynamics of the problem in addition to added grid requirements stemming from the multiphase or multi-physics aspect of the simulation. Therefore, a good starting point is to estimate the hydrodynamic grid requirement which can be corrected with stricter resolution requirement arising from these phenomena.
