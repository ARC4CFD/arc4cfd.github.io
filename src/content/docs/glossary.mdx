...
| LES: theory and applications, Piomelli | Ugo Piomelli, Large-Eddy Simulation: theory and applications - Lecture Series 2018-03, von Karman institute for Fluid Dynamics, Chaussee de Waterloo 72, Belgium |
| CAD | Computer-aided design |
| SGS | Sub-grid scale | 
| CPU-bound | Compute-bounded processes typical of most CFD softwares |
