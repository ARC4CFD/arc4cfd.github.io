...
High fidelity data must be generated, yet it is not a priori clear what data is relevant to understanding the problem.
...
Yet, large-scale data exchanges are a key part of the modern scientific community. Much of the efforts over the past X years have focused on developing freely accessible platforms to exchange large scale data. Although a curated dataset, from both experimental and computational fluid dynamics
