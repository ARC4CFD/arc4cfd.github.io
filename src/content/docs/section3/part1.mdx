...
For the most part, in CFD, it is the first two bullet points that impede a faster adoption of these principles.
...
Both represent integral parts of the data storage and have two different roles.
