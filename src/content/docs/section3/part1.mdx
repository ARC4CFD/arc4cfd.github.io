...
\cite{selent_management_2020} : paper explains the different stages of data in CFD
...
The FAIR principles \cite{wilkinson_fair_2016}
...
The TRUST principles underpin \cite{lin_trust_2020}
