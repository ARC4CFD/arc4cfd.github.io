...
A variety of different storage technologies have different use cases and associated costs.
...
The following figure illustrates a simplified decision tree to decide the data storage technologies.
...
The cloud-based storage is increasingly relevant for large-scale data sharing and collaboration.
